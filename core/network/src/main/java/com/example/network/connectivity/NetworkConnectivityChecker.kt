...
/**
 * Implementation of network connectivity checker using Android's ConnectivityManager
 * Handles both legacy and modern API approaches for network connectivity checking
 */
internal class NetworkConnectivityChecker(
